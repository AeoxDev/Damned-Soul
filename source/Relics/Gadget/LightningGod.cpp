...
{
	registry.AddComponent<ParticleComponent>(entity, LIGHTNING_GOD_SFX_DURATION_BIG, 0.0f, LIGHTNING_GOD_SFX_SIZE_BIG, 0.0f, 0.0f, 0.0f, LIGHTNING);
}
...
{
	registry.AddComponent<ParticleComponent>(entity, LIGHTNING_GOD_SFX_DURATION_SMALL, 0.0f, LIGHTNING_GOD_SFX_SIZE_SMALL, 0.0f, 0.0f, 0.0f, LIGHTNING);
}
