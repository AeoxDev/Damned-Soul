...
void LoadLevel1()
{
	...
	registry.AddComponent<ParticleComponent>(stage, 10, 20, 5, 0, 0, 60,20, FIRE); //(entity, float seconds, float radius, float size, float x, float y, float z,int amount ComputeShaders pattern)
