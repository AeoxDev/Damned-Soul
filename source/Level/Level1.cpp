...
void LoadLevel1()
{
	...
	registry.AddComponent<ParticleComponent>(stage, 2, 20, 5, 20, 0, 20, 20, FIRE); //(entity, float seconds, float radius, float size, float x, float y, float z,int amount ComputeShaders pattern)
	/*registry.AddComponent<ParticleComponent>(stage, 2, 20, 5, 20, 0, 20, 20, BOILING);*/ //(entity, float seconds, float radius, float size, float x, float y, float z,int amount ComputeShaders pattern)
