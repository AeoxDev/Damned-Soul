...
void LoadLevel5()
{
	...
	EntityID holderTwo = registry.CreateEntity();
	EntityID holderThree = registry.CreateEntity();

	CreatePointLight(lightholder, 0.6f, 0.1f, 0.0f, 64.0f, 10.0f, 185.0f, 700.0f, 20.0f);
	CreatePointLight(lightholderTwo, 0.6f, 0.1f, 0.0f, -309.0f, 10.0f, 163.0f, 200.0f, 20.0f);

	registry.AddComponent<ParticleComponent>(holder, 10, 15, 3.5, 0.0, 0.0, 0.0, 8, BOILING); //(entity, float seconds, float radius, float size, float x, float y, float z,int amount, ComputeShaders pattern)
	...
	registry.AddComponent<ParticleComponent>(holderTwo, 10, 30, 3.5,0.0, 0.0, 0.0, 17, BOILING); //(entity, float seconds, float radius, float size, float x, float y, float z,int amount, ComputeShaders pattern)
	TransformComponent tComp;
	tComp.positionX = 3.0;
	tComp.positionY = 2.0f;
	tComp.positionZ = 135.0;
	registry.AddComponent<TransformComponent>(holderTwo, tComp);

	registry.AddComponent<ParticleComponent>(holderThree, 10, 15, 3.5, 0.0f, 0.0f, 0.0f, 9, BOILING); //(entity, float seconds, float radius, float size, float x, float y, float z,int amount, ComputeShaders pattern)
	TransformComponent ttComp;
	ttComp.positionX = -309.0f;
	ttComp.positionY = 8.0f;
	ttComp.positionZ = 160.0;
	registry.AddComponent<TransformComponent>(holderThree, ttComp);
