...
bool CreateInputLayout(const char* vShaderByteCode, const unsigned int& size, ID3D11InputLayout*& il, const LAYOUT_DESC layout)
{
	...
	D3D11_INPUT_ELEMENT_DESC ParticleInputDesc[8] =
	{
		{"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0},
		...
		{"PATTERNS", 0, DXGI_FORMAT_R32_SINT, 0, 48, D3D11_INPUT_PER_VERTEX_DATA, 0},
		{"VFXPATTERNS", 0, DXGI_FORMAT_R32_SINT, 0, 52, D3D11_INPUT_PER_VERTEX_DATA, 0},
	};
