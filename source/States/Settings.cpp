...
void SettingsState::SetupButtons()
{
	...
	lowResComp->Setup("ExMenu/ButtonBackground.png", "ExMenu/ButtonBackgroundHover.png", L"1280x720", UIFunc::Settings_LowRes, { -0.20f, 0.1f }, { 0.8f, 0.8f });
	...
	mediumResComp->Setup("ExMenu/ButtonBackground.png", "ExMenu/ButtonBackgroundHover.png", L"1600x900", UIFunc::Settings_MediumRes, { 0.20f, 0.1f }, { 0.8f, 0.8f });
	...
	highResComp->Setup("ExMenu/ButtonBackground.png", "ExMenu/ButtonBackgroundHover.png", L"1920x1080", UIFunc::Settings_HighRes, { -0.20f, -0.35f }, { 0.8f, 0.8f });
	...
	fullscreenComp->Setup("ExMenu/ButtonBackground.png", "ExMenu/ButtonBackgroundHover.png", L"Fullscreen", UIFunc::Settings_Fullscreen, { 0.20f, -0.35f }, { 0.8f, 0.8f });

	//Back Button
	auto backButton = registry.CreateEntity();
	auto backComp = registry.AddComponent<UIButton>(backButton);
	backComp->Setup("ExMenu/ButtonBackground.png", "ExMenu/ButtonBackgroundHover.png", L"Back", UIFunc::Settings_Back, { -0.8f, -0.8f }, { 0.7f, 0.6f });	
}
...
void SettingsState::SetupImages()
{
	...
	panelComp->Setup("ExMenu/ButtonBackgroundHover.png", { 0.0f, 0.0f }, { 2.5f, 3.0f });
}
...
void SettingsState::SetupText()
{
	...
	headerComp->Setup(L"Settings", { 0.0f, 0.43f }, {1.0f, 1.0f});
