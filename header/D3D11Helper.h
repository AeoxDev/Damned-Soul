...
// Set an mode Vertex Buffer buffer by index
...
// Set an mode shader resource view buffer by index (shader and slot data contained in buffer)
...
// Set an mode unordered access view buffer by index (shader and slot data contained in buffer)
