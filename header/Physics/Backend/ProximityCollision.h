...
void ProximityCorrection(EntityID& wall, int& index, float& x, float& z, float& previousX, float& previousZ, float& speedX, float& speedZ); //Checks the entity is on the correct side of the wall
